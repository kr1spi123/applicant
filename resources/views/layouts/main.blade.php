    ...
    <footer>
        <div class="footer-content">
            <div class="footer-col">
                ...
                <div class="socials">
                    <a href="https://vk.com/forestinstitute" target="_blank" rel="noopener" title="ВКонтакте">
                    ...
                    <a href="https://sli.komi.com//" target="_blank" rel="noopener" title="Официальный сайт">
            ...
            <div class="footer-col">
                ...
                <ul class="contact-list">
                    <li>
                        <strong>Адрес:</strong>
                        <span>г. Сыктывкар, ул. Ленина, 39</span>
                    </li>
                    <li>
